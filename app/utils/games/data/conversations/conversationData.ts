...
export const CONVERSATION_SCENARIOS: ConversationScenario[] = [
  ...
  },
  {
    ...
    dialogues: [
      ...
      },
      {
        id: "vendor-fruits",
        speaker: "vendor",
        greek: "Έχουμε πολύ ωραία φρούτα! Μήλα, πορτοκάλια, μπανάνες. Τι προτιμάτε;",
        english: "We have very nice fruits! Apples, oranges, bananas. What do you prefer?",
        explanation: "The vendor shows available fruits and asks for preference.",
        culturalContext: "Greek vendors love to show off their fresh produce and make recommendations."
      },
      {
        ...
        options: [
          {
            ...
            culturalNote: "It's good to be specific about quantities and then ask about price."
          },
          {
            id: "option-2",
      ...
      },
      {
        id: "vendor-pricing",
        speaker: "vendor",
        greek: "Τα μήλα είναι 2 ευρώ το κιλό και τα πορτοκάλια 1,50 ευρώ. Θέλετε ένα κιλό από κάθε;",
        english: "The apples are 2 euros per kilo and the oranges 1.50 euros. Would you like a kilo of each?",
        explanation: "Vendor provides pricing and suggests quantities.",
        culturalContext: "Greek markets typically sell by weight (kilo) rather than by piece."
      },
      {
        ...
        options: [
          {
            ...
            english: "Yes, please! Half a kilo of apples and one kilo of oranges.",
            isCorrect: true,
            explanation: "Polite acceptance with specific quantities.",
            culturalNote: "It's common to buy different quantities of different items."
          },
          {
            id: "option-2",
            ...
            culturalNote: "If prices are high, it's better to negotiate politely or say you'll think about it."
          }
        ],
        correctOptionId: "option-1"
      },
      {
        ...
        english: "For you, the apples 1.80 euros! They are fresh from Thessaloniki.",
        explanation: "Vendor offers a discount and mentions the origin.",
        culturalContext: "Greek vendors often offer discounts to friendly customers and mention product origins."
      },
      {
        ...
        options: [
          {
            ...
            english: "Perfect! Thank you very much. Do you also want some vegetables?",
            isCorrect: true,
            explanation: "Shows appreciation and asks about additional items.",
            culturalNote: "It's good to show appreciation for the discount and explore more options."
          },
          {
            id: "option-2",
            greek: "Ακόμα ακριβά.",
            ...
            culturalNote: "Once a vendor offers a discount, it's better to accept graciously."
          }
        ],
        correctOptionId: "option-1"
      },
      {
        ...
        culturalContext: "Greek vegetables are known for their freshness and quality."
      },
      {
        id: "customer-final-order",
        speaker: "customer",
        ...
        options: [
          {
            ...
            english: "I'll take tomatoes and cucumbers too. How much is everything together?",
            isCorrect: true,
            explanation: "Makes final selection and asks for total price.",
            culturalNote: "It's common to ask for the total price of all items together."
          },
          {
            id: "option-2",
      ...
      },
      {
        ...
        culturalContext: "'Καλή όρεξη' is commonly used when selling food items."
      }
    ],
    vocabulary: [
      {
  ...
  },
  {
    ...
    difficulty: "intermediate",
    category: "travel",
    context: "You're at Athens International Airport and need to check in for your flight.",
    culturalBackground: "Greek airports are modern and efficient. Staff are generally helpful and many speak English, but using Greek shows respect and can be helpful.",
    dialogues: [
      {
        id: "checkin-greeting",
        speaker: "staff",
        ...
        culturalContext: "Greek airport staff are typically very helpful and professional."
      },
      {
        id: "customer-greeting",
        speaker: "customer",
        ...
        options: [
          {
            id: "option-1",
            greek: "Καλησπέρα! Ναι, παρακαλώ. Έχω κράτηση για την πτήση ΑΘ 123.",
            english: "Good evening! Yes, please. I have a reservation for flight ATH 123.",
            isCorrect: true,
            explanation: "Polite greeting with specific flight information.",
            culturalNote: "Always greet back and provide specific flight details."
          },
          {
            id: "option-2",
            ...
            culturalNote: "Be specific about your flight details when checking in."
          }
        ],
        correctOptionId: "option-1"
      },
      {
        id: "staff-passport",
        speaker: "staff",
        greek: "Βεβαίως! Μπορείτε να μου δείξετε το διαβατήριό σας και την κράτησή σας;",
        english: "Of course! Can you show me your passport and reservation?",
        explanation: "Staff requests necessary documents.",
        culturalContext: "Greek airport procedures are similar to international standards."
      },
      {
        ...
        options: [
          {
            ...
            culturalNote: "Always be cooperative and polite when providing documents."
          },
          {
            id: "option-2",
            ...
            culturalNote: "Airport procedures are standard and questioning them delays everyone."
          }
        ],
        correctOptionId: "option-1"
      },
        ...
        options: [
          {
            ...
            culturalNote: "It's good to know your baggage weight and ask about limits."
          },
          {
            id: "option-2",
            ...
            culturalNote: "Most international travelers have at least some luggage."
          }
        ],
        correctOptionId: "option-1"
      },
      {
        id: "staff-seat",
        speaker: "staff",
        greek: "Εντάξει! Θέλετε να επιλέξετε θέση; Έχουμε θέσεις δίπλα στο παράθυρο.",
        english: "Okay! Would you like to choose a seat? We have window seats available.",
      ...
      },
      {
        ...
        options: [
          {
            id: "option-1",
            greek: "Ναι, παρακαλώ! Θα ήθελα θέση δίπλα στο παράθυρο, αν είναι δυνατόν.",
      ...
      },
      {
        ...
        options: [
          ...
          },
          {
            ...
            culturalNote: "Always thank staff before asking additional questions."
          }
        ],
        correctOptionId: "option-1"
      }
  ...
  },
  {
    ...
    difficulty: "intermediate",
    category: "travel",
    context: "You're checking into a hotel in Athens and need to arrange your stay.",
    culturalBackground: "Greek hotels are known for their hospitality (filoxenia). Staff are very welcoming and often go out of their way to help guests.",
    dialogues: [
      {
        ...
        culturalContext: "Greek hotels are very welcoming and often greet guests warmly."
      },
      {
        id: "guest-greeting",
        speaker: "guest",
        ...
        options: [
          {
            id: "option-1",
            greek: "Καλησπέρα! Έχω κράτηση για δύο βράδια. Το όνομά μου είναι Γιώργος Παπαδόπουλος.",
            english: "Good evening! I have a reservation for two nights. My name is Giorgos Papadopoulos.",
            isCorrect: true,
            explanation: "Polite greeting with reservation details and name.",
            culturalNote: "Always provide your name and reservation details clearly."
          },
          {
            id: "option-2",
            greek: "Θέλω δωμάτιο.",
            ...
            culturalNote: "Be specific about your reservation when checking in."
          }
        ],
        correctOptionId: "option-1"
      },
      {
        ...
        speaker: "receptionist",
        greek: "Βεβαίως! Βρίσκω την κράτησή σας. Έχετε κράτηση για δωμάτιο με θέα στην Ακρόπολη.",
        english: "Of course! I found your reservation. You have a reservation for a room with Acropolis view.",
        explanation: "Receptionist confirms reservation details.",
        culturalContext: "Greek hotels often highlight their views of historical sites."
      },
      {
        ...
        options: [
          {
            id: "option-1",
            greek: "Τέλεια! Έχει το δωμάτιο μπαλκόνι; Και τι ώρα είναι το πρωινό;",
            english: "Perfect! Does the room have a balcony? And what time is breakfast?",
            isCorrect: true,
            explanation: "Asks relevant questions about room amenities and breakfast.",
            culturalNote: "It's good to ask about important amenities and meal times."
          },
          {
            id: "option-2",
            greek: "Πόσο κοστίζει;",
            ...
            culturalNote: "Focus on room details and services rather than price during check-in."
          }
        ],
        correctOptionId: "option-1"
      },
      {
        ...
        speaker: "receptionist",
        greek: "Ναι, έχει μπαλκόνι με υπέροχη θέα! Το πρωινό είναι από 7:00 έως 10:00. Έχετε επίσης πρόσβαση στην πισίνα.",
        english: "Yes, it has a balcony with wonderful view! Breakfast is from 7:00 to 10:00. You also have access to the pool.",
        explanation: "Receptionist provides information about amenities.",
        culturalContext: "Greek hotels often have pools and emphasize their views."
      },
      {
        id: "guest-wifi",
        speaker: "guest",
        ...
        options: [
          {
            id: "option-1",
            greek: "Εξαιρετικά! Έχει το ξενοδοχείο δωρεάν Wi-Fi; Και πού μπορώ να παρκάρω;",
            english: "Excellent! Does the hotel have free Wi-Fi? And where can I park?",
            isCorrect: true,
            explanation: "Asks about important modern amenities and parking.",
            culturalNote: "Wi-Fi and parking are important considerations for travelers."
          },
          {
            id: "option-2",
            greek: "Δεν με νοιάζει.",
      ...
      },
      {
        ...
        speaker: "receptionist",
        greek: "Ναι, έχουμε δωρεάν Wi-Fi σε όλο το ξενοδοχείο. Έχουμε υπόγειο πάρκινγκ με χρέωση 10 ευρώ την ημέρα.",
        english: "Yes, we have free Wi-Fi throughout the hotel. We have underground parking for 10 euros per day.",
        explanation: "Receptionist provides information about Wi-Fi and parking.",
        culturalContext: "Most Greek hotels offer Wi-Fi, and parking is often available for a fee."
      },
      {
        id: "guest-checkin",
        speaker: "guest",
        ...
        options: [
          {
            id: "option-1",
            greek: "Τέλεια! Μπορώ να κάνω check-in τώρα; Έχω την πιστωτική κάρτα μου.",
            english: "Perfect! Can I check in now? I have my credit card.",
            isCorrect: true,
            explanation: "Polite request to proceed with check-in.",
            culturalNote: "Always have your payment method ready during check-in."
          },
          {
            id: "option-2",
            ...
            culturalNote: "Complete the check-in process before asking about room location."
          }
        ],
        correctOptionId: "option-1"
      },
      {
        ...
        speaker: "receptionist",
        greek: "Βεβαίως! Το δωμάτιό σας είναι στον 3ο όροφο, αριθμός 305. Ο κλειδιάς σας. Καλή διαμονή!",
        english: "Of course! Your room is on the 3rd floor, number 305. Here are your keys. Have a pleasant stay!",
        explanation: "Receptionist provides room details and keys.",
        culturalContext: "Greek hotels often wish guests a pleasant stay (καλή διαμονή)."
      },
      {
        id: "guest-thanks",
        speaker: "guest",
        ...
        options: [
          {
            ...
            english: "Thank you very much! If I need anything else, I'll ask you.",
            isCorrect: true,
            explanation: "Polite thank you and acknowledgment of service.",
            culturalNote: "Always thank hotel staff and acknowledge their willingness to help."
          },
          {
            id: "option-2",
            greek: "Εντάξει.",
